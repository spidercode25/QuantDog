...
from infra.providers.news import NewsProvider, resolve_news_provider
from research.news_cache import fetch_recent_news, upsert_news_items
...
def create_orchestrator(
    ...
    """
    from research.llm_client import create_llm_client
