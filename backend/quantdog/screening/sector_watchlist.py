...
class SectorScreeningService:
    ...
    def _screen_sector(self, stocks: List[SectorStock]) -> List[ScreeningResult]:
        ...
        from quantdog.api.analysis import generate_baseline_analysis
        from quantdog.analysis.indicators import calculate_indicators
        from quantdog.infra.providers import YFinanceProvider
    ...
    def _run_ai_research(self, result: ScreeningResult) -> None:
        ...
        from quantdog.research.orchestrator import ResearchOrchestrator
        from quantdog.research.llm_client import MultiProviderLLMClient
        from quantdog.config import get_settings
        from quantdog.analysis.indicators import calculate_indicators
        from quantdog.infra.providers import YFinanceProvider
        from quantdog.research.models import RunContext, Horizon
        from datetime import datetime, timedelta
